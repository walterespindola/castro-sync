...
class _IBStub(object):
    """Stub para funciones de Firebird que no existen en InterBase 5.6 gds32.dll."""
    restype = None
    argtypes = []
...
class _DLLProxy(object):
    """Proxy sobre WinDLL que devuelve _IBStub para funciones ausentes (IB 5.6 compat)."""
    ...
    def __getattr__(self, name):
        ...
        try:
            ...
            return _IBStub(default_return=0)
...
class fbclient_API(object):
    ...
    def __init__(self, fb_library_name=None):
        ...
        # Compatibilidad InterBase 5.6: envuelve el DLL para que las funciones
        # ausentes devuelvan stubs en lugar de AttributeError.
        fb_library = _DLLProxy(fb_library)
        ...
        self.isc_service_start.argtypes = [POINTER(ISC_STATUS),
                                           ...
                                           c_ushort, STRING]
        #: isc_get_client_version -- no existe en IB 5.6
        try:
            ...
            self.isc_get_client_version = _IBStub(default_return=None)
        #: isc_get_client_major_version -- no existe en IB 5.6
        try:
            ...
            self.isc_get_client_major_version = _IBStub(default_return=5)
        #: isc_get_client_minor_version -- no existe en IB 5.6
        try:
            ...
            self.isc_get_client_minor_version = _IBStub(default_return=6)
        ...
        #: fb_shutdown_callback -- no existe en IB 5.6
        try:
            ...
            self.fb_shutdown_callback = _IBStub(default_return=0)
        #: fb_shutdown -- no existe en IB 5.6
        try:
            self.fb_shutdown = fb_library.fb_shutdown
            self.fb_shutdown.restype = c_int
            self.fb_shutdown.argtypes = [c_uint, c_int]
        except AttributeError:
            self.fb_shutdown = _IBStub(default_return=0)
